...
import * as middleware from 'app/core/middleware'
// import DevTools from 'app/components/DevTools'
// import { getDebugSessionKey } from './getDebugSessionKey'
// import { persistState } from 'redux-devtools'
import { compose } from 'utils'

import * as reducers from 'app/core/reducers'
...
export default function Core() {
  ...
  if (module.hot) {
    module.hot.accept('app/core/reducers', () => store.replaceReducer(reducer)) // probably won't work
  }
